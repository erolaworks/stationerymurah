				...
				<div id="grid">
					...
					if(!empty($_POST['sort']) OR !empty($_GET['sortir'])){
						...
						if($sort == "baru" OR $sortir == "baru"){
							$sql = mysql_query ("select * from barang where status = 'baru' limit $posisi, $batas");
						}else if($sort == "asc" OR $sortir == "asc"){
							$sql = mysql_query ("select * from barang order by nama_barang limit $posisi, $batas");
						}else if($sort == "desc" OR $sortir == "desc"){
							$sql = mysql_query ("select * from barang order by nama_barang desc limit $posisi, $batas");
						}else if($sort == "termurah" OR $sortir == "termurah"){
							$sql = mysql_query ("select * from barang order by harga limit $posisi, $batas");
						}else{
							$sql = mysql_query ("select * from barang order by harga desc limit $posisi, $batas");
						}
					}else{
									...
									<figcaption>
										...
										<table>
											<tr>
												...
												<td class="beli"><span><a href="">beli</a></span></td>
											</tr>
										</table>
									</figcaption>
								</figure>
