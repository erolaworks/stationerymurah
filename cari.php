		...
		<div id="container">
			...
			<div id="form-input">
				...
				<div id="search">
					<form action="" method="post">
						<label for="cari.php">Kata kunci</label>
			...
			<tr>
				...
				if($jenis == "kodebarang"){
					...
					$sql = mysql_query ("select kode_barang, nama_barang, harga, nama_kategori, stok, nama_satuan from barang tb left join kategori tk on tb.kode_kategori = tk.kode_kategori left join satuan ts on tb.kode_satuan = ts.kode_satuan where nama_satuan like '%$cari%'");
				}			
