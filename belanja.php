			...
			<div id="kanan">
				...
				<div class="announce">
					<section class="belanja">
						<article>
							<h4>Keranjang Belanja Online</h4>
							<p>Belanja jadi lebih mudah hanya dengan klik tombol 'beli' di daftar produk atau di halaman detil produk yang Anda pilih, 
							maka produk tersebut akan masuk ke keranjang belanja Anda. Selanjutnya ikuti prosedur perincian belanja Anda.</p>
						</article>
					</section>
					<section class="belanja">
						<article>
							<h4>Via Telepon</h4>
							<p>Pemesanan lewat telepon dapat menghubungi langsung (021) 345 8989.</p>
						</article>
					</section>
					<section class="belanja">
						<article>
					...
					<section class="belanja">
						<article>
							...
							<p>Anda dapat datang langsung ke toko stationery.com pada alamat berikut.<br />
								Pasar Koja Baru blok AKS A181 <br />
								belakang toko mas Chin Chiang <br />
